...
function priority()
{
	$.ajax({
		url:"expertreg",
		data:{"errorname":$('#errorname').val(),"type":"programming"}, /* #medfor is catch from the below code and medfor is send as a logical name to servlet */
		/* method:"abcS", */
		success:function(data)
		{ 
			/* here data contain what ever print in servlet 
  ...
  <div class="container">
    <div class="header_section">
      ...
      <!--   <ul class="toggle">
        ...
        <ul class="">
           <li><a href="experthomeprogramming.jsp">Home</a></li>
    ...
    <form action="expertsolution" method="post" onsubmit="return validate()">        
            <div>
            	<br/>
            		<br/>
            			<br/>
            			<h1>Enter your errors to find the solution</h1>
            				<br/>
            					<br/>
       ...
       <%--   <form action="retriveError" method="post" >  --%> 
            ...
            <table>
            <tr>
            <td><strong>Enter your Error</strong></td><td>
...
<%
	...
	System.out.println("Test==errortype="+errortype);
     ...
     AESAlgorithm aes = new AESAlgorithm();
           ...
           PreparedStatement ps=con.prepareStatement("select distinct errorname from programming where errortype=? and errorsolution='NULL' ORDER BY severity ASC");
...
<%
	    		...
	    		try{
	                ...
	                PreparedStatement ps1 =con1.prepareStatement("SELECT * FROM programming WHERE errorname='"+eerrorname+"'");
	    			...
	    			System.out.println("days "+diffDays );
	    					...
	    					System.out.print(diffSeconds + " seconds.");
	    			    	  ...
	    			    	  if(diffDays>0){
	    			    		  ...
	    			    		  PreparedStatement ps2 = con2.prepareStatement("INSERT INTO `bugswitch`.`unsolvederror` (`id`, `errorname`) VALUES ('null', '"+errorname2+"');");
...
%>
         ...
         <td ><input type="button" onclick="priority()" value="Priority"></td>
          ...
          <tr>
            <center><td colspan="4" align="center"><input type="submit" value="Submit"/> </td></tr></center>
