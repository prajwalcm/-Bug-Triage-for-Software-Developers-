...
function priority()
{
	$.ajax({
		url:"expertreg",
		data:{"errorname":$('#errorname').val(),"type":"system"}, /* #medfor is catch from the below code and medfor is send as a logical name to servlet */
		/* method:"abcS", */
		success:function(data)
		{ 
			/* here data contain what ever print in servlet 
...
<%
	...
	System.out.println("Test==errortype="+errortype);
     ...
     AESAlgorithm aes = new AESAlgorithm();
           ...
           PreparedStatement ps=con.prepareStatement("select distinct errorname from system where errortype=? and errorsolution='NULL' ORDER BY severity ASC");
...
<%
	    		...
	    		try{
	                ...
	                PreparedStatement ps1 =con1.prepareStatement("SELECT * FROM system WHERE errorname='"+eerrorname+"'");
