...
function priority()
{
	$.ajax({
		url:"expertreg",
		data:{"errorname":$('#errorname').val(),"type":"other"}, /* #medfor is catch from the below code and medfor is send as a logical name to servlet */
		/* method:"abcS", */
		success:function(data)
		{ 
			/* here data contain what ever print in servlet 
  ...
  <div class="container">
    <div class="header_section">
      ...
      <!--   <ul class="toggle">
        ...
        <ul class="">
           <li><a href="experthomeother.jsp">Home</a></li>
...
<%
	...
	System.out.println("Test==errortype="+errortype);
     ...
     AESAlgorithm aes = new AESAlgorithm();
           ...
           PreparedStatement ps=con.prepareStatement("select distinct errorname from other where errortype=? and errorsolution='NULL' ORDER BY severity ASC");
...
<%
	    		...
	    		try{
	                ...
	                PreparedStatement ps1 =con1.prepareStatement("SELECT * FROM other WHERE errorname='"+eerrorname+"'");
